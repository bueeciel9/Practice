...
class DADA3d(Attention3d):
    ...
    def calculate_density(self, num_points, max_num_points_per_voxel):
        density = num_points / max_num_points_per_voxel
        return density

    def find_reference_and_adjacent_voxel_indices(self, voxel_centers, reference_voxels, voxel_size):
        reference_indices = []
    ...
    def forward(self, sp_tensor):
        ...
        reference_voxels = voxel_centers.clone()
        reference_indices, adjacent_indices_list, highest_density_indices_list = self.find_reference_and_adjacent_voxel_indices(voxel_centers, reference_voxels, sp_tensor.voxel_size)
